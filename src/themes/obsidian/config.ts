...
const commonColorsBlue: [string, string] = [
  'rgb(8, 109, 221)',
  'rgb(2, 122, 255)',
]
const commonColorsTeal: [string, string] = [
  'rgb(0, 191, 188)',
  'rgb(83, 223, 221)',
]
const commonColorsOrange: [string, string] = [
  'rgb(236, 117, 0)',
  'rgb(233, 151, 63)',
]
const commonColorsGreen: [string, string] = [
  'rgb(8, 185, 78)',
  'rgb(68, 207, 110)',
]
const commonColorsRed: [string, string] = [
  'rgb(233, 49, 71)',
  'rgb(251, 70, 76)',
]
const commonColorsPurple: [string, string] = [
  'rgb(120, 82, 238)',
  'rgb(168, 130, 255)',
]

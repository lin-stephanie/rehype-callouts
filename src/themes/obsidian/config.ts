...
export const obsidianCallouts: DefaultCallouts = {
  ...
  success: {
    ...
    color: ['rgb(8, 185, 78)', 'rgb(68, 207, 110)'],
  },
  check: {
    title: 'Check',
    indicator:
  ...
  question: {
    ...
    color: ['rgb(236, 117, 0)', 'rgb(233, 151, 63)'],
  },
  help: {
    title: 'Help',
    indicator:
  ...
  failure: {
    ...
    color: ['rgb(233, 49, 71)', 'rgb(251, 70, 76)'],
  },
  missing: {
    title: 'Missing',
    indicator:
  ...
  example: {
    ...
    color: ['rgb(120, 82, 238)', 'rgb(168, 130, 255)'],
  },
  quote: {
    title: 'Quote',
    indicator:
